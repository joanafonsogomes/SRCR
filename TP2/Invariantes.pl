...
%Adicionar uma vacinaçao da toma 2 requer que a toma 1 ja esteja na base de conhecimento e que ambas as doses sejam do mesmo tipo:
...
%Garantir que a vacinação é efetuada por um membro da staff que trabalhe no centro onde o utente está escrito
