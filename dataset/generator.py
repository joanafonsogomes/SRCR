...
doencas = ["Insuficiência cardíaca","Doenca coronária","Insuficiência renal","Diabetes","Neoplasia maligna ativa","Doenca renal crónica","Insuficiência hepática","Hipertensão arterial","Obesidade"]
profissoes = ["Auxiliar de produção", "Auxiliar administrativo", "Advogado", "Administrador", "Advogado trabalhista", "Auditor fiscal", "Auxiliar de cozinha", "Agricultor", "Analista financeiro", "Assistente social", "Analista administrativo", "Assistente administrativo", "Arquiteto", "Assistente financeiro", "Assistente comercial", "Assistente de marketing", "Auxiliar de expedição", "Agrônomo", "Ator", "Assistente pessoal", "Arqueólogo", "Agente de saúde", "Analista de sistemas", "Auxiliar de limpeza", "Alfaiate", "Advogado criminalista", "Auxiliar de Enfermagem", "Bancário", "Business partner", "Bartender", "Biólogo", "Bombeiro", "Biomédico", "Bioquímico", "Bombeiro civil", "Clínico geral", "Contabilista", "Cozinheiro", "Contador", "Confeiteiro", "Corretor de imóveis", "Consultor de vendas", "Cientista de dados", "Controller", "Cardiologista", "Cenógrafo", "Cabeleireiro", "Chefe de cozinha", "Cirurgião plástico", "Cuidador de idosos", "Comissário de bordo", "Carteiro", "Cerimonialista", "Coach", "Corretor de seguros", "Desembargador", "Designer de interiores", "Delegado", "Designer", "Diplomata", "DevOps", "Dentista", "DPO (Data protection officer)", "Desenvolvedor", "Despachante", "DBA (Administrador de Banco de Dados)", "Designer de moda", "Desenhista", "Empresário", "Esteticista", "Encanador", "Engenheiro mecânico", "Economista", "Estoquista", "Engenheiro de produção", "Editor de texto", "Engenheiro químico", "Estilista", "Engenheiro civil", "Enfermeiro", "Endocrinologista", "Engenheiro de controle e automação", "Engenheiro de materiais", "Engenheiro ambiental", "Eletricista", "Engenheiro agrônomo", "Engenheiro elétrico", "Embaixador", "Engenheiro de software", "Engenheiro de alimentos", "Fotógrafo", "Fisioterapeuta", "Fuzileiro naval", "Farmacêutico", "Figurinista", "Filósofo", "Ginecologista", "Geriatra", "Gestor hospitalar", "Gestor ambiental", "Geógrafo", "Headhunter", "Intérprete de libras", "Jornalista", "Jovem Aprendiz", "Juiz", "Médico", "Militar", "Mestre cervejeiro", "Marinheiro", "Massoterapeuta", "Mecânico de carro", "Motorista", "Maestro", "Neurologista", "Nutrólogo", "Nutricionista", "Obstetra", "Oftalmologista", "Operador de caixa", "Oficial de Justiça", "Operador de telemarketing", "Profissional de help desk", "Profissional de Facilities", "Pizzaiolo", "Psicólogo", "Padeiro", "Piloto de avião", "Promotor de justiça", "Personal trainer", "Perito criminal", "Profissional de Logística", "Pedagogo", "Perito judicial", "Psiquiatra", "Personal stylist", "Programador", "Produtor de vídeo", "Podólogo", "Pediatra", "Professor", "Promotor de vendas", "Publicitário", "Proctologista", "Psicopedagogo", "Profissional de Relações Públicas", "Profissional de Linguística", "Policial militar", "Quiroprata", "Químico", "Roteirizador", "Roteirista", "Recepcionista", "Radialista", "Repórter", "Representante comercial", "Social Media", "Técnico em Segurança do Trabalho", "Trader", "Técnico em Radiologia", "Terapeuta ocupacional", "Torneiro mecânico", "Turismólogo", "Teólogo", "Taquígrafo", "Técnico de Enfermagem", "Terapeuta", "Técnico em edificações", "Técnico em informática", "Urologista", "Vigilante", "Veterinário", "Webmaster", "Web designer"]
centros = ["de Braga", "do Carandá", "do Cávado", "Dr.Paulo Novais"]
vacinas = ["Pfizer","Astrazeneca","Johnson&Johnson","Moderna"]
moradas= []
